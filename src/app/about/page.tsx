        ...
        <Box flex="1" overflowX="auto" ml={{ base: "4rem", lg: "6rem" }}>
          <Box bg={"linear-gradient(224deg, #4985F4 18.66%, #185ABC 68.67%)"}>
            ...
            >
              ...
              >
                ...
                Deleniti delectus ipsam quia iusto explicabo aliquam, harum eum
                consequatur quae adipisci eius quibusdam, eos quo repellendus,
                fugit placeat! Accusantium quisquam illum porro voluptate
                mollitia veniam corrupti quibusdam doloribus, repellendus
                tenetur. Doloremque facere placeat, adipisci explicabo aliquam
                accusantium at sit iusto veritatis?
              </Text>
            </Flex>{" "}
          </Box>
          <Box
          ...
          >
            ...
            >
              ...
              itaque. Cupiditate saepe reiciendis tempora odio explicabo?
              Corporis sapiente dolores perspiciatis similique, excepturi
              voluptate molestias mollitia dignissimos repellendus impedit
              accusamus consequatur distinctio.
            </Text>
          </Box>
          <Box bg={"#FFFFFF"}>
            <Grid
            ...
            >
              ...
              <GridItem display={"flex"} alignItems={"center"} p={"1rem"}>
                ...
                >
                  ...
                  amet, consectetur adipiscing elit. Maecenas rutrum, leo
                  laoreet feugiat vehicula, magna lacus blandit felis, non
                  tincidunt diam mi accumsan orci. Nunc hendrerit blandit erat,
